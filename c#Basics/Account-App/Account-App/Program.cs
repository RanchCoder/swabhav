...
namespace Account_App
{
    class Program
    {
        ...
        public static void WithdrawalMessageInfo(Account a,bool responseParameter) {
            ...
            Console.WriteLine($"Withdrawl Successful, Current Account Balance : {a.Balance}");
        }   
        ...
        public static void DepositMessageInfo(Account a,bool responseParameter)
        {
            ...
            Console.WriteLine($"Deposit Successful, Current Account Balance : {a.Balance}");
        }
